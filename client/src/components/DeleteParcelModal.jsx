                  ...
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Êtes-vous sûr de vouloir supprimer le colis {parcel?.tracking_number} ? Cette action est irréversible et supprimera également :
                      </p>
                      <ul className="mt-2 list-disc list-inside text-sm text-gray-500">
                        <li>Toutes les photos associées</li>
                        <li>L'historique des statuts</li>
                        <li>Les notifications liées</li>
                        <li>Les statistiques associées</li>
                      </ul>
                    </div>
                  </div>
                </div>
